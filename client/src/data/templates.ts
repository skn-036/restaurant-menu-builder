...
const { restaurantContainer } = useCreateTemplate('restaurant');
const { productContainer } = useCreateTemplate('product');

const templates: Template[] = [
    {
        id: 'template-c7f17922-483b-4917-b1a6-1d75d7bf934c',
        name: 'Demo 1',
        background:
        ...
        mapper: [
            { key: '100px', A4: '100px', A5: '72px' },
            { key: '96px', A4: '96px', A5: '48px' },
            { key: '75px', A4: '75px', A5: '54px' },
            { key: '48px', A4: '48px', A5: '32px' },
            { key: '32px', A4: '32px', A5: '24px' },
            { key: '30px', A4: '30px', A5: '22px' },
            { key: '27px', A4: '27px', A5: '18px' },
            { key: '24px', A4: '24px', A5: '20px' },
            { key: '20px', A4: '20px', A5: '16px' },
            { key: '16px', A4: '16px', A5: '14px' },
            { key: '14px', A4: '14px', A5: '12px' },
            { key: '600', A4: '600', A5: '400' },
        ],
        ...
        >
            ...
            <div style="margin-left: 96px; margin-top: 32px">
                <div
                    style="
                        padding-left: 0px;
                        text-align: right;
...
`,
        ...
        product: `<div class="wrapper-div" style="width: 100%;">
        <div
        ...
        restaurantBuilder: restaurantContainer.value,
        productBuilder: productContainer.value,
    },
];
